<template>
  <div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <!-- Filtros -->
    <div class="flex flex-wrap gap-4 mb-8 p-4 bg-gray-900 rounded-lg border border-gray-800">
      ...
      <select v-model="filters.genre" @change="applyFilters"
        class="bg-gray-800 border border-gray-700 rounded px-3 py-2 text-gray-100 text-sm focus:outline-none focus:border-blue-500">
...
async function applyFilters() {
  await gamesStore.fetchGames(buildParams())
}
